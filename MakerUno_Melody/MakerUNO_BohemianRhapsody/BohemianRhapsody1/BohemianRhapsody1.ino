...
int bohemian1Melody[] = {
  NOTE_F5, NOTE_F5, NOTE_F5, NOTE_F5, NOTE_F5, 0,
  NOTE_E5, NOTE_E5, NOTE_F5, NOTE_E5, NOTE_D5, NOTE_C5, 0,
  NOTE_F5, NOTE_F5, NOTE_F5, NOTE_G5, NOTE_F5,
  NOTE_F4, NOTE_F4, NOTE_F5, NOTE_F5, NOTE_G5, NOTE_F5, NOTE_DS5, NOTE_D5, 0,

  NOTE_D5, NOTE_D5, NOTE_D5, NOTE_D5, NOTE_D5, 0,
  NOTE_D5, NOTE_D5, NOTE_DS5, NOTE_F5, NOTE_AS4, NOTE_G5, 0, 0,
  NOTE_G5, NOTE_G5, NOTE_G5, NOTE_G5, NOTE_G5, 0,
  NOTE_F5, NOTE_F5, NOTE_G5, NOTE_F5, NOTE_DS5, NOTE_C5,
  0, NOTE_D5, NOTE_DS5,
  
  NOTE_B5, NOTE_B5, NOTE_AS5, 0,
  NOTE_A5, NOTE_A5, NOTE_AS5, 0,
  NOTE_B5, NOTE_B5, NOTE_AS5, 0,
  NOTE_A5, NOTE_A5, NOTE_AS5, 0,

  NOTE_G5, NOTE_G5, NOTE_G5, NOTE_G5, NOTE_F5, NOTE_AS5,
  NOTE_E5, NOTE_E5, NOTE_E5, NOTE_E5, NOTE_F5,
  NOTE_C5, NOTE_A4, NOTE_F5, 0,

  NOTE_A4, NOTE_AS4, NOTE_AS4,

  NOTE_G6, NOTE_F6, 0, NOTE_G6, NOTE_F6,
};
